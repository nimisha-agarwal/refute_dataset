...
^
e160_280506.c:25:14: warning: incompatible integer to pointer conversion passing 'int' to parameter of type 'int *'; take the address with & [-Wint-conversion]
        k = similar(a[i]);
                    ^~~~
                    &
...
int similar(int X[])//function declaration.
                ^
e160_280506.c:22:8: warning: variable 'n' is uninitialized when used here [-Wuninitialized]
        int a[n];//declaration of array.
              ^
e160_280506.c:21:12: note: initialize the variable 'n' to silence this warning
