...
int check(int a[],int n)
              ^
e160_280501.c:17:16: warning: incompatible integer to pointer conversion passing 'int' to parameter of type 'int *'; take the address with & [-Wint-conversion]
        else if(check(a[n],n==0))
                      ^~~~
                      &
e160_280501.c:2:15: note: passing argument to parameter 'a' here
int check(int a[],int n)
