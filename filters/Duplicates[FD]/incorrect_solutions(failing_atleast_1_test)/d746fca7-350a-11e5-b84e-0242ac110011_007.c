/*compile-errors:e160_280540.c:20:43: warning: if statement has empty body [-Wempty-body]
                if(duplicate(arr[i],arr[i+1])==0);
                                                 ^
e160_280540.c:20:43: note: put the semicolon on a separate line to silence this warning
