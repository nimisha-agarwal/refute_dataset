/*compile-errors:e160_280506.c:26:18: warning: incompatible integer to pointer conversion passing 'int' to parameter of type 'int *'; take the address with & [-Wint-conversion]
...
int main()
{
    int n,k;//declaration of varaible.
