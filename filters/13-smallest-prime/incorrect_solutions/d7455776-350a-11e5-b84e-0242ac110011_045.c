...
e158_278300.c:7:12: note: use '==' to turn this assignment into an equality comparison
    if (num=1)
           ^
           ==
e158_278300.c:9:16: warning: using the result of an assignment as a condition without parentheses [-Wparentheses]
   else if (num=2)
            ~~~^~
e158_278300.c:9:16: note: place parentheses around the assignment to silence this warning
   else if (num=2)
               ^
            (    )
e158_278300.c:9:16: note: use '==' to turn this assignment into an equality comparison
   else if (num=2)
               ^
               ==
