...
int main()
{
    ...
    if(a+b>c && b+c>a && c+a>b){      //valid triangle condtion
        cosA=(b*b+c*c-a*a)/(2.0*b*c);   //using cosine rule for angle A
        cosB=(c*c+a*a-b*b)/(2.0*a*c);   //for angle B
        cosC=(a*a+b*b-c*c)/(2.0*a*b);   //for angle C                                                         /* all types are mutually                                              exclusive that is a right triangle                                      can't be acute or abtuse & so on*/
