/*compile-errors:e156_271798.c:6:18: warning: variable 'z' is uninitialized when used here [-Wuninitialized]
     if(x>=y&&x>=z)
                 ^
...
{   int a,b,c,x,y,z;
               ^
                = 0
e156_271798.c:6:12: warning: variable 'y' is uninitialized when used here [-Wuninitialized]
     if(x>=y&&x>=z)
           ^
