/*compile-errors:e156_271832.c:6:17: warning: format specifies type 'int *' but the argument has type 'int' [-Wformat]
    scanf("%d", s1);
           ~~   ^~
e156_271832.c:7:17: warning: format specifies type 'int *' but the argument has type 'int' [-Wformat]
    scanf("%d", s2);
           ~~   ^~
e156_271832.c:8:17: warning: format specifies type 'int *' but the argument has type 'int' [-Wformat]
    scanf("%d", s3);
           ~~   ^~
...
e156_271832.c:5:11: note: initialize the variable 's1' to silence this warning
    int s1, s2, s3, x, y; //s1, s2, s3 are sides of a triangle
          ^
           = 0
e156_271832.c:7:17: warning: variable 's2' is uninitialized when used here [-Wuninitialized]
    scanf("%d", s2);
                ^~
e156_271832.c:5:15: note: initialize the variable 's2' to silence this warning
    int s1, s2, s3, x, y; //s1, s2, s3 are sides of a triangle
              ^
               = 0
e156_271832.c:8:17: warning: variable 's3' is uninitialized when used here [-Wuninitialized]
    scanf("%d", s3);
                ^~
