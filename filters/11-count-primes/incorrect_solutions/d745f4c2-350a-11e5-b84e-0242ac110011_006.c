...
int x,y;
       ^
        = 0
e158_278069.c:21:9: warning: unused variable 'N' [-Wunused-variable]
    int N;
        ^
e158_278069.c:28:17: warning: variable 'b' is uninitialized when used here [-Wuninitialized]
    if (a==i && b==(i+2)){
                ^
e158_278069.c:22:14: note: initialize the variable 'b' to silence this warning
    int i,a,b,count,num;
             ^
              = 0
e158_278069.c:28:9: warning: variable 'a' is uninitialized when used here [-Wuninitialized]
    if (a==i && b==(i+2)){
        ^
e158_278069.c:22:12: note: initialize the variable 'a' to silence this warning
    int i,a,b,count,num;
           ^
            = 0
e158_278069.c:25:17: warning: variable 'num' is uninitialized when used here [-Wuninitialized]
    for (i=2;i<=num;i++){
                ^~~
e158_278069.c:22:24: note: initialize the variable 'num' to silence this warning
    int i,a,b,count,num;
                       ^
                        = 0
