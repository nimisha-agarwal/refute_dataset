/*compile-errors:e156_271775.c:7:20: warning: format specifies type 'int *' but the argument has type 'int' [-Wformat]
    scanf("%d%d%d",a,b,c);
           ~~      ^
e156_271775.c:7:22: warning: format specifies type 'int *' but the argument has type 'int' [-Wformat]
    scanf("%d%d%d",a,b,c);
             ~~      ^
...
e156_271775.c:5:18: note: initialize the variable 'y' to silence this warning
    int a,b,c,x,y,z;
                 ^
                  = 0
e156_271775.c:7:24: warning: variable 'c' is uninitialized when used here [-Wuninitialized]
    scanf("%d%d%d",a,b,c);
                       ^
...
e156_271775.c:5:20: note: initialize the variable 'z' to silence this warning
    int a,b,c,x,y,z;
                   ^
                    = 0
e156_271775.c:7:20: warning: variable 'a' is uninitialized when used here [-Wuninitialized]
    scanf("%d%d%d",a,b,c);
                   ^
...
e156_271775.c:5:16: note: initialize the variable 'x' to silence this warning
    int a,b,c,x,y,z;
               ^
                = 0
e156_271775.c:7:22: warning: variable 'b' is uninitialized when used here [-Wuninitialized]
    scanf("%d%d%d",a,b,c);
                     ^
