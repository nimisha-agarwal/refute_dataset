...
e156_271775.c:23:6: note: use '=' to turn this equality comparison into an assignment
    z==a;
     ^~
     =
e156_271775.c:25:6: warning: equality comparison result unused [-Wunused-comparison]
    D==y*y+z*z-x*x;
    ~^~~~~~~~~~~~~
e156_271775.c:25:6: note: use '=' to turn this equality comparison into an assignment
    D==y*y+z*z-x*x;
     ^~
     =
