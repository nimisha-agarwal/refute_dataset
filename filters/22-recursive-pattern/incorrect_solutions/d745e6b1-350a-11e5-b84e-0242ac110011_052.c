...
e175_306017.c:22:9: warning: unused variable 'x' [-Wunused-variable]
    int x=print_pattern2(d);
        ^
e175_306017.c:19:7: warning: variable 'n' is uninitialized when used here [-Wuninitialized]
    A=n;
      ^
e175_306017.c:18:10: note: initialize the variable 'n' to silence this warning
    int n;
         ^
          = 0
